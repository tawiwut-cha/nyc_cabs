'''
Module for streamlit application
'''
...
from data.preprocess import (NYC_MIN_LON, NYC_MAX_LON, NYC_MIN_LAT, NYC_MAX_LAT)
from features import features_cols, compute_trip_distance, get_features
...
def user_input():
    ...
    pickup_lat = st.number_input('pickup latitude', min_value=NYC_MIN_LAT, max_value=NYC_MAX_LAT, value=40.7580)
    pickup_lon = st.number_input('pickup longitude', min_value=NYC_MIN_LON, max_value=NYC_MAX_LON, value=-73.9855)
    dropoff_lat = st.number_input('dropoff latitude', min_value=NYC_MIN_LAT, max_value=NYC_MAX_LAT, value=40.7800)
    dropoff_lon = st.number_input('dropoff longitude', min_value=NYC_MIN_LON, max_value=NYC_MAX_LAT, value=-73.6900)
